...
Net::Cassandra::Backend::Cassandra_login_args->mk_accessors( qw( auth_request ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_login_result->mk_accessors( qw( ) );
...
package Net::Cassandra::Backend::Cassandra_set_keyspace_args;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_set_keyspace_args->mk_accessors( qw( keyspace ) );
...
package Net::Cassandra::Backend::Cassandra_set_keyspace_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_set_keyspace_result->mk_accessors( qw( ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_get_args->mk_accessors( qw( key column_path consistency_level ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_get_slice_args->mk_accessors( qw( key column_parent predicate consistency_level ) );
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem72 = undef;
            $elem72 = new Net::Cassandra::Backend::ColumnOrSuperColumn();
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_get_count_args->mk_accessors( qw( key column_parent predicate consistency_level ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_multiget_slice_args->mk_accessors( qw( keys column_parent predicate consistency_level ) );
...
package Net::Cassandra::Backend::Cassandra_multiget_count_args;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_multiget_count_args->mk_accessors( qw( keys column_parent predicate consistency_level ) );
...
package Net::Cassandra::Backend::Cassandra_multiget_count_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_multiget_count_result->mk_accessors( qw( success ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_get_range_slices_args->mk_accessors( qw( column_parent predicate range consistency_level ) );
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem118 = undef;
            $elem118 = new Net::Cassandra::Backend::KeySlice();
...
package Net::Cassandra::Backend::Cassandra_get_indexed_slices_args;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_get_indexed_slices_args->mk_accessors( qw( column_parent index_clause column_predicate consistency_level ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      last; };
      /^2$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{index_clause} = new Net::Cassandra::Backend::IndexClause();
      ...
      last; };
      /^3$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{column_predicate} = new Net::Cassandra::Backend::SlicePredicate();
...
package Net::Cassandra::Backend::Cassandra_get_indexed_slices_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_get_indexed_slices_result->mk_accessors( qw( success ) );
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem125 = undef;
            $elem125 = new Net::Cassandra::Backend::KeySlice();
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_insert_args->mk_accessors( qw( key column_parent column consistency_level ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_remove_args->mk_accessors( qw( key column_path timestamp consistency_level ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_batch_mutate_args->mk_accessors( qw( mutation_map consistency_level ) );
...
package Net::Cassandra::Backend::Cassandra_truncate_args;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_truncate_args->mk_accessors( qw( cfname ) );
...
package Net::Cassandra::Backend::Cassandra_truncate_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_truncate_result->mk_accessors( qw( ) );
...
package Net::Cassandra::Backend::Cassandra_describe_schema_versions_args;
use base qw(Class::Accessor);
...
package Net::Cassandra::Backend::Cassandra_describe_schema_versions_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_describe_schema_versions_result->mk_accessors( qw( success ) );
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem173 = undef;
            $elem173 = new Net::Cassandra::Backend::KsDef();
      ...
      /^0$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem180 = undef;
            $elem180 = new Net::Cassandra::Backend::TokenRange();
...
package Net::Cassandra::Backend::Cassandra_describe_partitioner_args;
use base qw(Class::Accessor);
...
package Net::Cassandra::Backend::Cassandra_describe_partitioner_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_describe_partitioner_result->mk_accessors( qw( success ) );
...
package Net::Cassandra::Backend::Cassandra_describe_snitch_args;
use base qw(Class::Accessor);
...
package Net::Cassandra::Backend::Cassandra_describe_snitch_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_describe_snitch_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Net::Cassandra::Backend::KsDef();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_describe_splits_args->mk_accessors( qw( cfName start_token end_token keys_per_split ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_add_column_family_result->mk_accessors( qw( success ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_drop_column_family_args->mk_accessors( qw( column_family ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_drop_column_family_result->mk_accessors( qw( success ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_add_keyspace_result->mk_accessors( qw( success ) );
...
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_drop_keyspace_result->mk_accessors( qw( success ) );
...
package Net::Cassandra::Backend::Cassandra_system_update_keyspace_args;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_update_keyspace_args->mk_accessors( qw( ks_def ) );
...
package Net::Cassandra::Backend::Cassandra_system_update_keyspace_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_update_keyspace_result->mk_accessors( qw( success ) );
...
package Net::Cassandra::Backend::Cassandra_system_update_column_family_args;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_update_column_family_args->mk_accessors( qw( cf_def ) );
...
package Net::Cassandra::Backend::Cassandra_system_update_column_family_result;
use base qw(Class::Accessor);
Net::Cassandra::Backend::Cassandra_system_update_column_family_result->mk_accessors( qw( success ) );
...
sub send_set_keyspace{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_set_keyspace_args();
...
sub recv_set_keyspace{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_set_keyspace_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_multiget_count{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_multiget_count_args();
  $args->{keys} = $keys;
  $args->{column_parent} = $column_parent;
  $args->{predicate} = $predicate;
  $args->{consistency_level} = $consistency_level;
...
sub recv_multiget_count{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_multiget_count_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_get_indexed_slices{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_get_indexed_slices_args();
  $args->{column_parent} = $column_parent;
...
sub recv_get_indexed_slices{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_get_indexed_slices_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_truncate{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_truncate_args();
  $args->{cfname} = $cfname;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_truncate{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_truncate_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_describe_schema_versions{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_describe_schema_versions_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_describe_schema_versions{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_describe_schema_versions_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_describe_partitioner{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_describe_partitioner_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_describe_partitioner{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_describe_partitioner_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_describe_snitch{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_describe_snitch_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_describe_snitch{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_describe_snitch_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_system_update_keyspace{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_system_update_keyspace_args();
  $args->{ks_def} = $ks_def;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_system_update_keyspace{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_system_update_keyspace_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_system_update_column_family{
  ...
  my $args = new Net::Cassandra::Backend::Cassandra_system_update_column_family_args();
  $args->{cf_def} = $cf_def;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_system_update_column_family{
  ...
  my $result = new Net::Cassandra::Backend::Cassandra_system_update_column_family_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
